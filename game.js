        ...
        update() {
            ...
            this.game.enemies.forEach(enemy => {
                if(this.game.checkCollision(this, enemy)[0]) {
                    ...
                    for (let i = 0; i < 5; i++) {
                        this.game.particles.push(new Firefly(this.game, this.collisionX, this.collisionY, 'blue'));
                    }
                }
            });
    ...
    class Game {
        ...
        render(context, deltaTime) {
            ...
            if (this.score >= this.winningScore) {
                ...
                context.fillText("Final score " + this.score + ". Press 'R' to try again... better!", this.width * 0.5, this.height * 0.5 + 80)
                context.restore();
            }
        }
        checkCollision(a, b) {
